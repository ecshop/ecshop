...
function get_sysnav()
{
    ...
    $sysmain = [
        ...
        [$_LANG['group_buy_goods'], 'group_buy.php'],
        [$_LANG['snatch'], 'snatch.php'],
        [$_LANG['tag_cloud'], 'tag_cloud.php'],
        [$_LANG['user_center'], 'user.php'],
        [$_LANG['wholesale'], 'wholesale.php'],
        [$_LANG['activity'], 'activity.php'],
        [$_LANG['myship'], 'myship.php'],
        [$_LANG['message_board'], 'message.php'],
        [$_LANG['quotation'], 'quotation.php'],
    ];
