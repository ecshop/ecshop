...
if ($_REQUEST['act'] == 'list') {
    ...
    if (! $is_multi) {
        ...
        $smarty->assign('action_link', ['text' => $_LANG['down_order_statistics'], 'href' => 'order_stats.php?act=download&start_date='.$start_date.'&end_date='.$end_date.'&filename='.$filename]);
    }
