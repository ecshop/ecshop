...
{
    #[OA\Post(path: '/comment/query', summary: '查询列表接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function store(CommentCreateRequest $createRequest): JsonResponse
    {
        ...
        try {
            ...
            $commentService = new CommentService;
            if ($commentService->save($input->toEntity())) {
                DB::commit();
    ...
    public function update(CommentUpdateRequest $updateRequest): JsonResponse
    {
        ...
        try {
            ...
            $commentService->updateById($input->toEntity(), $id);
    ...
    #[OA\Delete(path: '/comment/destroy', summary: '删除接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function destroy(CommentDestroyRequest $destroyRequest): JsonResponse
    {
        ...
        try {
            $commentService = new CommentService;
            if ($commentService->removeByIds($requestData['ids'])) {
                DB::commit();
