...
use App\Api\Admin\Requests\GoodsArticle\GoodsArticleCreateRequest;
use App\Api\Admin\Requests\GoodsArticle\GoodsArticleDestroyRequest;
use App\Api\Admin\Requests\GoodsArticle\GoodsArticleQueryRequest;
use App\Api\Admin\Requests\GoodsArticle\GoodsArticleUpdateRequest;
use App\Api\Admin\Responses\GoodsArticle\GoodsArticleDestroyResponse;
use App\Api\Admin\Responses\GoodsArticle\GoodsArticleQueryResponse;
use App\Api\Admin\Responses\GoodsArticle\GoodsArticleResponse;
use App\Entities\GoodsArticleEntity;
use App\Services\GoodsArticleService;
...
{
    #[OA\Post(path: '/goodsArticle/query', summary: '查询列表接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function query(GoodsArticleQueryRequest $queryRequest): JsonResponse
    {
        ...
        try {
            $condition = [];
            if (isset($requestData[GoodsArticleQueryRequest::getAdminId])) {
                $condition[] = [GoodsArticleEntity::getAdminId, '=', $requestData[GoodsArticleQueryRequest::getAdminId]];
            }
            ...
            $goodsArticleService = new GoodsArticleService;
            $result = $goodsArticleService->page($condition, $page, $pageSize);
    ...
    #[OA\Post(path: '/goodsArticle/store', summary: '新增接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function store(GoodsArticleCreateRequest $createRequest): JsonResponse
    {
        ...
        try {
            ...
            $goodsArticleService = new GoodsArticleService;
            if ($goodsArticleService->save($input->toEntity())) {
                DB::commit();
    ...
    #[OA\Get(path: '/goodsArticle/show', summary: '获取详情接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function show(Request $request): JsonResponse
    {
        ...
        try {
            $goodsArticleService = new GoodsArticleService;
            $goodsArticle = $goodsArticleService->getOneById($id);
    ...
    #[OA\Put(path: '/goodsArticle/update', summary: '更新接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    #[OA\Parameter(name: 'id', description: 'ID', in: 'query', required: true, example: 1)]
    ...
    public function update(GoodsArticleUpdateRequest $updateRequest): JsonResponse
    {
        ...
        try {
            ...
            $goodsArticleService->updateById($input->toEntity(), $id);
    ...
    #[OA\Delete(path: '/goodsArticle/destroy', summary: '删除接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function destroy(GoodsArticleDestroyRequest $destroyRequest): JsonResponse
    {
        ...
        try {
            $goodsArticleService = new GoodsArticleService;
            if ($goodsArticleService->removeByIds($requestData['ids'])) {
                DB::commit();
