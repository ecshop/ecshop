...
use App\Api\Admin\Requests\ShippingArea\ShippingAreaUpdateRequest;
...
{
    #[OA\Post(path: '/shippingArea/query', summary: '查询列表接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    #[OA\Post(path: '/shippingArea/store', summary: '新增接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function store(ShippingAreaCreateRequest $createRequest): JsonResponse
    {
        ...
        try {
            ...
            $shippingAreaService = new ShippingAreaService;
            if ($shippingAreaService->save($input->toEntity())) {
                DB::commit();
    ...
    #[OA\Get(path: '/shippingArea/show', summary: '获取详情接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function show(Request $request): JsonResponse
    {
        ...
        try {
            $shippingAreaService = new ShippingAreaService;
            $shippingArea = $shippingAreaService->getOneById($id);
    ...
    #[OA\Put(path: '/shippingArea/update', summary: '更新接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    #[OA\Parameter(name: 'id', description: 'ID', in: 'query', required: true, example: 1)]
    ...
    public function update(ShippingAreaUpdateRequest $updateRequest): JsonResponse
    {
        ...
        try {
            ...
            $shippingAreaService->updateById($input->toEntity(), $id);
    ...
    #[OA\Delete(path: '/shippingArea/destroy', summary: '删除接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    public function destroy(ShippingAreaDestroyRequest $destroyRequest): JsonResponse
    {
        ...
        try {
            $shippingAreaService = new ShippingAreaService;
            if ($shippingAreaService->removeByIds($requestData['ids'])) {
                DB::commit();
