...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: self::getReturnTime, description: '', type: 'integer'),
        new OA\Property(property: self::getAgencyId, description: '', type: 'integer'),
    ]
)]
class BackOrderUpdateRequest extends FormRequest
{
    ...
    const string getReturnTime = 'returnTime';
    ...
    public function messages(): array
    {
        return [
            ...
            self::getReturnTime.'.required' => '请设置',
