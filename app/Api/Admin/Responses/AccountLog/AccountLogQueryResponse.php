...
#[OA\Schema(schema: 'AccountLogQueryResponse')]
class AccountLogQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AccountLogResponse::class))]
    private array $data;
