...
#[OA\Schema(schema: 'AdsenseQueryResponse')]
class AdsenseQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AdsenseResponse::class))]
    private array $data;
