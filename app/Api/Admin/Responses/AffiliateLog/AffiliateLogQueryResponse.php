...
#[OA\Schema(schema: 'AffiliateLogQueryResponse')]
class AffiliateLogQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AffiliateLogResponse::class))]
    private array $data;
