...
#[OA\Schema(schema: 'AgencyQueryResponse')]
class AgencyQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AgencyResponse::class))]
    private array $data;
