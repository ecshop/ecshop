...
#[OA\Schema(schema: 'AreaRegionQueryResponse')]
class AreaRegionQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AreaRegionResponse::class))]
    private array $data;
