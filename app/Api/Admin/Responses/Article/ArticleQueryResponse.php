...
namespace App\Api\Admin\Responses\Article;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ArticleQueryResponse')]
class ArticleQueryResponse
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ArticleResponse::class))]
    private array $data;
