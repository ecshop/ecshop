...
namespace App\Api\Admin\Responses\Attribute;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'AttributeQueryResponse')]
class AttributeQueryResponse
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AttributeResponse::class))]
    private array $data;
