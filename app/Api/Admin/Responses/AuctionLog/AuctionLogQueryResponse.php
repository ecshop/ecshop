...
#[OA\Schema(schema: 'AuctionLogQueryResponse')]
class AuctionLogQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AuctionLogResponse::class))]
    private array $data;
