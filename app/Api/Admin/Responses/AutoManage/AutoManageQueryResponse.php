...
#[OA\Schema(schema: 'AutoManageQueryResponse')]
class AutoManageQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AutoManageResponse::class))]
    private array $data;
