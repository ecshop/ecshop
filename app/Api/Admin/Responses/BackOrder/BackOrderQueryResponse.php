...
namespace App\Api\Admin\Responses\BackOrder;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'BackOrderQueryResponse')]
class BackOrderQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: BackOrderResponse::class))]
    private array $data;
