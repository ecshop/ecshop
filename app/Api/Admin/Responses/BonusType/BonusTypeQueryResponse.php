...
namespace App\Api\Admin\Responses\BonusType;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'BonusTypeQueryResponse')]
class BonusTypeQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: BonusTypeResponse::class))]
    private array $data;
