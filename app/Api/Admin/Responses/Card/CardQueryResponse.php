...
#[OA\Schema(schema: 'CardQueryResponse')]
class CardQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CardResponse::class))]
    private array $data;
