...
#[OA\Schema(schema: 'CatRecommendQueryResponse')]
class CatRecommendQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CatRecommendResponse::class))]
    private array $data;
