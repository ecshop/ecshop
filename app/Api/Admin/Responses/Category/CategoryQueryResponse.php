...
namespace App\Api\Admin\Responses\Category;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'CategoryQueryResponse')]
class CategoryQueryResponse
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CategoryResponse::class))]
    private array $data;
