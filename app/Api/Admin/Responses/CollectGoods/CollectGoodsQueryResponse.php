...
namespace App\Api\Admin\Responses\CollectGoods;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'CollectGoodsQueryResponse')]
class CollectGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CollectGoodsResponse::class))]
    private array $data;
