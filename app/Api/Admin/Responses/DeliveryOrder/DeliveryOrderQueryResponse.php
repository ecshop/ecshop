...
#[OA\Schema(schema: 'DeliveryOrderQueryResponse')]
class DeliveryOrderQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: DeliveryOrderResponse::class))]
    private array $data;
