...
namespace App\Api\Admin\Responses\EmailSendlist;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'EmailSendlistQueryResponse')]
class EmailSendlistQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: EmailSendlistResponse::class))]
    private array $data;
