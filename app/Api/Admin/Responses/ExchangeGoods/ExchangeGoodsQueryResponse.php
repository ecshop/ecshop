...
#[OA\Schema(schema: 'ExchangeGoodsQueryResponse')]
class ExchangeGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ExchangeGoodsResponse::class))]
    private array $data;
