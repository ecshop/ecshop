...
#[OA\Schema(schema: 'FavourableActivityQueryResponse')]
class FavourableActivityQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: FavourableActivityResponse::class))]
    private array $data;
