...
#[OA\Schema(schema: 'GoodsQueryResponse')]
class GoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsResponse::class))]
    private array $data;
