...
namespace App\Api\Admin\Responses\GoodsGallery;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'GoodsGalleryQueryResponse')]
class GoodsGalleryQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsGalleryResponse::class))]
    private array $data;
