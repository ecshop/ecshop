...
#[OA\Schema(schema: 'GroupGoodsQueryResponse')]
class GroupGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GroupGoodsResponse::class))]
    private array $data;
