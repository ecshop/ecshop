...
#[OA\Schema(schema: 'KeywordsQueryResponse')]
class KeywordsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: KeywordsResponse::class))]
    private array $data;
