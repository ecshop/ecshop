...
#[OA\Schema(schema: 'LinkGoodsQueryResponse')]
class LinkGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: LinkGoodsResponse::class))]
    private array $data;
