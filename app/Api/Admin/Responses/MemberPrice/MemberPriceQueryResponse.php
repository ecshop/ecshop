...
#[OA\Schema(schema: 'MemberPriceQueryResponse')]
class MemberPriceQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: MemberPriceResponse::class))]
    private array $data;
