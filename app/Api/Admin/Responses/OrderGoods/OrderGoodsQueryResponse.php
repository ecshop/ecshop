...
#[OA\Schema(schema: 'OrderGoodsQueryResponse')]
class OrderGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderGoodsResponse::class))]
    private array $data;
