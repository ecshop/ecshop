...
namespace App\Api\Admin\Responses\OrderInfo;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'OrderInfoQueryResponse')]
class OrderInfoQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderInfoResponse::class))]
    private array $data;
