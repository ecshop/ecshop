...
#[OA\Schema(schema: 'PackQueryResponse')]
class PackQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: PackResponse::class))]
    private array $data;
