...
#[OA\Schema(schema: 'PackageGoodsQueryResponse')]
class PackageGoodsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: PackageGoodsResponse::class))]
    private array $data;
