...
namespace App\Api\Admin\Responses\RegExtendInfo;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'RegExtendInfoQueryResponse')]
class RegExtendInfoQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RegExtendInfoResponse::class))]
    private array $data;
