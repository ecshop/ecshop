...
#[OA\Schema(schema: 'RegFieldsQueryResponse')]
class RegFieldsQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RegFieldsResponse::class))]
    private array $data;
