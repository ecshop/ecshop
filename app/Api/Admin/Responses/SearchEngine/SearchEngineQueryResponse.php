...
#[OA\Schema(schema: 'SearchEngineQueryResponse')]
class SearchEngineQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SearchEngineResponse::class))]
    private array $data;
