...
#[OA\Schema(schema: 'SessionsDataQueryResponse')]
class SessionsDataQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SessionsDataResponse::class))]
    private array $data;
