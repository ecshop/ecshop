...
namespace App\Api\Admin\Responses\ShippingArea;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ShippingAreaQueryResponse')]
class ShippingAreaQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShippingAreaResponse::class))]
    private array $data;
