...
#[OA\Schema(schema: 'SnatchLogQueryResponse')]
class SnatchLogQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SnatchLogResponse::class))]
    private array $data;
