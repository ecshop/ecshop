...
namespace App\Api\Admin\Responses\Suppliers;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SuppliersQueryResponse')]
class SuppliersQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SuppliersResponse::class))]
    private array $data;
