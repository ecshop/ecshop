...
namespace App\Api\Admin\Responses\Topic;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'TopicQueryResponse')]
class TopicQueryResponse
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: TopicResponse::class))]
    private array $data;
