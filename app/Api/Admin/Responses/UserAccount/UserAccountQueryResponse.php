...
#[OA\Schema(schema: 'UserAccountQueryResponse')]
class UserAccountQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserAccountResponse::class))]
    private array $data;
