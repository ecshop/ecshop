...
#[OA\Schema(schema: 'UserBonusQueryResponse')]
class UserBonusQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserBonusResponse::class))]
    private array $data;
