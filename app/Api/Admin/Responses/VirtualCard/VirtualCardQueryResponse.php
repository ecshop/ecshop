...
namespace App\Api\Admin\Responses\VirtualCard;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'VirtualCardQueryResponse')]
class VirtualCardQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: VirtualCardResponse::class))]
    private array $data;
