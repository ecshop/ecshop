...
#[OA\Schema(schema: 'VolumePriceQueryResponse')]
class VolumePriceQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: VolumePriceResponse::class))]
    private array $data;
