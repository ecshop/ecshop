...
#[OA\Schema(schema: 'VoteLogQueryResponse')]
class VoteLogQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: VoteLogResponse::class))]
    private array $data;
