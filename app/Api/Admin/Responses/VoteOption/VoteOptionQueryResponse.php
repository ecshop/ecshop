...
namespace App\Api\Admin\Responses\VoteOption;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'VoteOptionQueryResponse')]
class VoteOptionQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: VoteOptionResponse::class))]
    private array $data;
