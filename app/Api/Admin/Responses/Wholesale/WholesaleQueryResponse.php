...
namespace App\Api\Admin\Responses\Wholesale;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'WholesaleQueryResponse')]
class WholesaleQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: WholesaleResponse::class))]
    private array $data;
