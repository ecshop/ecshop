...
class SnatchController extends InitController
{
    ...
    public function listAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['snatch_add'], 'href' => 'snatch.php?act=add'));
    ...
    public function editAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['02_snatch_list'], 'href' => 'snatch.php?act=list&' . list_link_postfix()));
