...
#[OA\Schema(schema: 'BackOrderEntity')]
class BackOrderEntity
{
    use DTOHelper;

    const string getBackId = 'back_id';

    const string getDeliverySn = 'delivery_sn';
    ...
    const string getUpdateTime = 'update_time';

    const string getSuppliersId = 'suppliers_id';

    const string getStatus = 'status';

    const string getReturnTime = 'return_time';
    ...
    #[OA\Property(property: 'returnTime', description: '', type: 'integer')]
