...
class Article
{
    ...
    #[OA\Property(property: 'author_email', description: '', type: 'string')]
    protected string $authorEmail;

    #[OA\Property(property: 'keywords', description: '', type: 'string')]
    protected string $keywords;

    #[OA\Property(property: 'article_type', description: '', type: 'integer')]
    protected int $articleType;

    #[OA\Property(property: 'is_open', description: '', type: 'integer')]
    protected int $isOpen;

    #[OA\Property(property: 'add_time', description: '', type: 'integer')]
    protected int $addTime;

    #[OA\Property(property: 'file_url', description: '', type: 'string')]
    protected string $fileUrl;

    #[OA\Property(property: 'open_type', description: '', type: 'integer')]
