...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td class="first-cell">
    <span onclick="javascript:listTable.edit(this, 'edit_ad_name', {{ $list['ad_id'] }})">{{ $list['ad_name'] }}</span>
    </td>
    <td align="left"><span>@if($list['position_id'] == 0){{ $lang['outside_posit'] }}@else{{ $list['position_name'] }}@endif</span>
    </td>
