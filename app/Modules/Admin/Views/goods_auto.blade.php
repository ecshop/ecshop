...
<tr>
  ...
  <td align="center">
  <span onclick="listTable.edit(this, 'edit_starttime', '{{ $val['goods_id'] }}');showCalendar(this.firstChild, '%Y-%m-%d', false, false, this.firstChild)">@if($val['starttime']){{ $val['starttime'] }}@else0000-00-00@endif</span>
</td>
  <td align="center">
  <span onclick="listTable.edit(this, 'edit_endtime', '{{ $val['goods_id'] }}');showCalendar(this.firstChild, '%Y-%m-%d', false, false, this.firstChild)">@if($val['endtime']){{ $val['endtime'] }}@else0000-00-00@endif</span>
  </td>
