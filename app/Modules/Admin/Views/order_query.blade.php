    ...
    <tr>
      ...
      <td colspan="3">
        <select name="order_status" id="select9">
          ...
          @foreach($os_list as $__k => $__v)<option value="{{ $__k }}">{{ $__v }}</option>@endforeach
        </select>
        <strong>{{ $lang['label_pay_status'] }}</strong>        <select name="pay_status" id="select11">
          <option value="-1">{{ $lang['select_please'] }}</option>
          @foreach($ps_list as $__k => $__v)<option value="{{ $__k }}">{{ $__v }}</option>@endforeach
        </select>
        <strong>{{ $lang['label_shipping_status'] }}</strong>        <select name="shipping_status" id="select10">
          <option value="-1">{{ $lang['select_please'] }}</option>
          @foreach($ss_list as $__k => $__v)<option value="{{ $__k }}">{{ $__v }}</option>@endforeach
        </select></td>
    </tr>
    <tr>
