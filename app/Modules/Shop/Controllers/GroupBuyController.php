...
{
    #[OA\Get(path: 'group-buy', summary: '接口', tags: ['模块'])]
    ...
    public function index(): Renderable
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            /* 如果没有缓存，生成缓存 */
            if (! $smarty->is_cached('group_buy_list', $cache_id)) {
                if ($count > 0) {
                    /* 取得当前页的团购活动 */
        ...
        if ($_REQUEST['act'] == 'view') {
            ...
            /* 如果没有缓存，生成缓存 */
            if (! $smarty->is_cached('group_buy_goods', $cache_id)) {
            ...
            return $this->display('group_buy_goods');
        }
