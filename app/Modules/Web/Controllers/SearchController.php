        ...
        /* ------------------------------------------------------ */
            ...
            if (! empty($_REQUEST['keywords'])) {
                ...
                foreach ($arr as $k => $val) {
                    ...
                    $db->autoReplace($ecs->table('keywords'), ['date' => local_date('Y-m-d'),
            ...
            $display = (isset($_REQUEST['display']) && in_array(trim(strtolower($_REQUEST['display'])), ['list', 'grid', 'text'])) ? trim($_REQUEST['display']) : (isset($_SESSION['display_search']) ? $_SESSION['display_search'] : $default_display_type);
            ...
            $this->assign('keywords', htmlspecialchars(stripslashes($_REQUEST['keywords']), ENT_QUOTES, 'UTF-8'));
