...
class ActivityBonusRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ActivityBonusEntity $entity): int    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ActivityBonusEntity
    {
        ...
        $entity = new ActivityBonusEntity();
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ActivityBonusEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ActivityBonus'): Model
    {
