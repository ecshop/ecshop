...
class ActivityPackageRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ActivityPackageEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ActivityPackageEntity
    {
        ...
        $entity = new ActivityPackageEntity;
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ActivityPackageEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ActivityPackage'): Model
    {
