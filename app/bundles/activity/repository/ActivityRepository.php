...
class ActivityRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ActivityEntity $entity): int    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ActivityEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ActivityEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'Activity'): Model
    {
