...
class ActivityWholesaleRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ActivityWholesaleEntity $entity): int    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ActivityWholesaleEntity
    {
        ...
        $entity = new ActivityWholesaleEntity();
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ActivityWholesaleEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ActivityWholesale'): Model
    {
