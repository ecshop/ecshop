...
class AdCustomRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(AdCustomEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?AdCustomEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?AdCustomEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'AdCustom'): Model
    {
