...
class GoodsGalleryRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?GoodsGalleryEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?GoodsGalleryEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'GoodsGallery'): Model
    {
