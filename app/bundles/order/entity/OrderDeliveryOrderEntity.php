...
#[OA\Schema(schema: 'OrderDeliveryOrderEntity')]
class OrderDeliveryOrderEntity
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'delivery_sn', description: '发货单号', type: 'string')]
    ...
    #[OA\Property(property: 'add_time', description: '创建时间', type: 'integer')]
    ...
    #[OA\Property(property: 'status', description: '发货状态(0未发货 1已发货)', type: 'integer')]
    private int $status;
