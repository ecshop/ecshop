...
class OrderDeliveryGoodsRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(OrderDeliveryGoodsEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?OrderDeliveryGoodsEntity
    {
        ...
        $entity = new OrderDeliveryGoodsEntity;
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?OrderDeliveryGoodsEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'OrderDeliveryGoods'): Model
    {
