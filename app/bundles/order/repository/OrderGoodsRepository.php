...
class OrderGoodsRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(OrderGoodsEntity $entity): int    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?OrderGoodsEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?OrderGoodsEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'OrderGoods'): Model
    {
