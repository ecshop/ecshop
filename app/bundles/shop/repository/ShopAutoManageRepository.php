...
class ShopAutoManageRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ShopAutoManageEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ShopAutoManageEntity
    {
        ...
        $entity = new ShopAutoManageEntity;
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ShopAutoManageEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ShopAutoManage'): Model
    {
