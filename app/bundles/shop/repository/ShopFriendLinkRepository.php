...
class ShopFriendLinkRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ShopFriendLinkEntity $entity): int    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ShopFriendLinkEntity
    {
        ...
        $entity = new ShopFriendLinkEntity();
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ShopFriendLinkEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ShopFriendLink'): Model
    {
