...
class ShopNavRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(ShopNavEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?ShopNavEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?ShopNavEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'ShopNav'): Model
    {
