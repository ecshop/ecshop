...
class UserAddressRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?UserAddressEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?UserAddressEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'UserAddress'): Model
    {
