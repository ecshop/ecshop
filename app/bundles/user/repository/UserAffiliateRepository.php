...
class UserAffiliateRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(UserAffiliateEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?UserAffiliateEntity
    {
        ...
        $entity = new UserAffiliateEntity;
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?UserAffiliateEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'UserAffiliate'): Model
    {
