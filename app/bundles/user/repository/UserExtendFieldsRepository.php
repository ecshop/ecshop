...
class UserExtendFieldsRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByEntity(UserExtendFieldsEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneEntityById(int $id): ?UserExtendFieldsEntity
    {
        ...
        $entity = new UserExtendFieldsEntity;
     ...
     * 按照条件查询
     */
    public function findOneEntity(array $condition): ?UserExtendFieldsEntity
    {
     ...
     * 定义数据数据模型类
     */
    public function model(string $modelName = 'UserExtendFields'): Model
    {
