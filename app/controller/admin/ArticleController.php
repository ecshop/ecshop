...
class ArticleController extends InitController
{
    ...
    public function listAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['article_add'], 'href' => 'article.php?act=add'));
    ...
    public function addAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['03_article_list'], 'href' => 'article.php?act=list'));
    ...
    public function editAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['03_article_list'], 'href' => 'article.php?act=list&' . list_link_postfix()));
