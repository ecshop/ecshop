...
class FriendLinkController extends InitController
{
    ...
    public function listAction()
    {
        ...
        $this->assign('action_link', array('text' => $_LANG['add_link'], 'href' => 'friend_link.php?act=add'));
    ...
    public function addAction()
    {
        ...
        $this->assign('action_link', array('href' => 'friend_link.php?act=list', 'text' => $_LANG['list_link']));
    ...
    public function editAction()
    {
        ...
        $this->assign('action_link', array('href' => 'friend_link.php?act=list&' . list_link_postfix(), 'text' => $_LANG['list_link']));
