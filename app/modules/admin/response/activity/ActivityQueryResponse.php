...
#[OA\Schema(schema: 'ActivityQueryResponse')]
class ActivityQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityResponse::class))]
    private array $data;
