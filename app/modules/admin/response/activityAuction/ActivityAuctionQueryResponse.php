...
#[OA\Schema(schema: 'ActivityAuctionQueryResponse')]
class ActivityAuctionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityAuctionResponse::class))]
    private array $data;
