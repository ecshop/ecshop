...
#[OA\Schema(schema: 'ActivityBonusQueryResponse')]
class ActivityBonusQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityBonusResponse::class))]
    private array $data;
