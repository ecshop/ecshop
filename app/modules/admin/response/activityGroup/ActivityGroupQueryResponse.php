...
#[OA\Schema(schema: 'ActivityGroupQueryResponse')]
class ActivityGroupQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityGroupResponse::class))]
    private array $data;
