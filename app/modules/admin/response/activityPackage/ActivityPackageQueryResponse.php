...
#[OA\Schema(schema: 'ActivityPackageQueryResponse')]
class ActivityPackageQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityPackageResponse::class))]
    private array $data;
