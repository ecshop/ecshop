...
#[OA\Schema(schema: 'ActivitySnatchQueryResponse')]
class ActivitySnatchQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivitySnatchResponse::class))]
    private array $data;
