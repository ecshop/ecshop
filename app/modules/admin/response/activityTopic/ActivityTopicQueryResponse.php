...
#[OA\Schema(schema: 'ActivityTopicQueryResponse')]
class ActivityTopicQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityTopicResponse::class))]
    private array $data;
