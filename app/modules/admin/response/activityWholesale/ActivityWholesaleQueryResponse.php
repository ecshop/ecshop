...
#[OA\Schema(schema: 'ActivityWholesaleQueryResponse')]
class ActivityWholesaleQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ActivityWholesaleResponse::class))]
    private array $data;
