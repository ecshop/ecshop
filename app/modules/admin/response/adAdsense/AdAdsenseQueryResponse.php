...
#[OA\Schema(schema: 'AdAdsenseQueryResponse')]
class AdAdsenseQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AdAdsenseResponse::class))]
    private array $data;
