...
#[OA\Schema(schema: 'AdminRoleQueryResponse')]
class AdminRoleQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AdminRoleResponse::class))]
    private array $data;
