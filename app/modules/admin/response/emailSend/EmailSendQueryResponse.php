...
#[OA\Schema(schema: 'EmailSendQueryResponse')]
class EmailSendQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: EmailSendResponse::class))]
    private array $data;
