...
#[OA\Schema(schema: 'EmailSubscriptionQueryResponse')]
class EmailSubscriptionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: EmailSubscriptionResponse::class))]
    private array $data;
