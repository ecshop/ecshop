...
#[OA\Schema(schema: 'GoodsActivityQueryResponse')]
class GoodsActivityQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsActivityResponse::class))]
    private array $data;
