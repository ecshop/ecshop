...
#[OA\Schema(schema: 'GoodsAttrQueryResponse')]
class GoodsAttrQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsAttrResponse::class))]
    private array $data;
