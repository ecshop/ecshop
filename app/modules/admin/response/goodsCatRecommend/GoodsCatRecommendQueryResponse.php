...
#[OA\Schema(schema: 'GoodsCatRecommendQueryResponse')]
class GoodsCatRecommendQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsCatRecommendResponse::class))]
    private array $data;
