...
#[OA\Schema(schema: 'GoodsCategoryQueryResponse')]
class GoodsCategoryQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsCategoryResponse::class))]
    private array $data;
