...
#[OA\Schema(schema: 'GoodsLinkGoodsQueryResponse')]
class GoodsLinkGoodsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsLinkGoodsResponse::class))]
    private array $data;
