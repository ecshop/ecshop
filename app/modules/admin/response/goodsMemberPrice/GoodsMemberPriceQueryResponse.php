...
#[OA\Schema(schema: 'GoodsMemberPriceQueryResponse')]
class GoodsMemberPriceQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsMemberPriceResponse::class))]
    private array $data;
