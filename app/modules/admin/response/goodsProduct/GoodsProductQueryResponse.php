...
#[OA\Schema(schema: 'GoodsProductQueryResponse')]
class GoodsProductQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsProductResponse::class))]
    private array $data;
