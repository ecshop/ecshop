...
#[OA\Schema(schema: 'GoodsTypeAttributeQueryResponse')]
class GoodsTypeAttributeQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsTypeAttributeResponse::class))]
    private array $data;
