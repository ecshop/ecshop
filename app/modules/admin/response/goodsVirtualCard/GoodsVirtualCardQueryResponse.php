...
#[OA\Schema(schema: 'GoodsVirtualCardQueryResponse')]
class GoodsVirtualCardQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsVirtualCardResponse::class))]
    private array $data;
