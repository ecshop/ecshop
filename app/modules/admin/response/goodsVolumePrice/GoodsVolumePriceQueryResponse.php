...
#[OA\Schema(schema: 'GoodsVolumePriceQueryResponse')]
class GoodsVolumePriceQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: GoodsVolumePriceResponse::class))]
    private array $data;
