...
#[OA\Schema(schema: 'OrderActionQueryResponse')]
class OrderActionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderActionResponse::class))]
    private array $data;
