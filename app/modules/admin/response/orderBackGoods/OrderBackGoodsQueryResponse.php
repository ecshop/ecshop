...
#[OA\Schema(schema: 'OrderBackGoodsQueryResponse')]
class OrderBackGoodsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderBackGoodsResponse::class))]
    private array $data;
