...
#[OA\Schema(schema: 'OrderBackOrderQueryResponse')]
class OrderBackOrderQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderBackOrderResponse::class))]
    private array $data;
