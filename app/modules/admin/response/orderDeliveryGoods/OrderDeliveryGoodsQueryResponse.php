...
#[OA\Schema(schema: 'OrderDeliveryGoodsQueryResponse')]
class OrderDeliveryGoodsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderDeliveryGoodsResponse::class))]
    private array $data;
