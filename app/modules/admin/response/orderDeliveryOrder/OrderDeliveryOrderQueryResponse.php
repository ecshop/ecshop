...
namespace app\modules\admin\response\orderDeliveryOrder;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'OrderDeliveryOrderQueryResponse')]
class OrderDeliveryOrderQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: OrderDeliveryOrderResponse::class))]
    private array $data;
