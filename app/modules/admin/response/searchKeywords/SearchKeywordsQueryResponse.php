...
#[OA\Schema(schema: 'SearchKeywordsQueryResponse')]
class SearchKeywordsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SearchKeywordsResponse::class))]
    private array $data;
