...
#[OA\Schema(schema: 'ShippingAreaRegionQueryResponse')]
class ShippingAreaRegionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShippingAreaRegionResponse::class))]
    private array $data;
