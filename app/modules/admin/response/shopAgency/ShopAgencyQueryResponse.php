...
#[OA\Schema(schema: 'ShopAgencyQueryResponse')]
class ShopAgencyQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopAgencyResponse::class))]
    private array $data;
