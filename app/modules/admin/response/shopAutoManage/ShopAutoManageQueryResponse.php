...
#[OA\Schema(schema: 'ShopAutoManageQueryResponse')]
class ShopAutoManageQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopAutoManageResponse::class))]
    private array $data;
