...
#[OA\Schema(schema: 'ShopCardQueryResponse')]
class ShopCardQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopCardResponse::class))]
    private array $data;
