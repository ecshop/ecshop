...
#[OA\Schema(schema: 'ShopCronQueryResponse')]
class ShopCronQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopCronResponse::class))]
    private array $data;
