...
#[OA\Schema(schema: 'ShopErrorLogQueryResponse')]
class ShopErrorLogQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopErrorLogResponse::class))]
    private array $data;
