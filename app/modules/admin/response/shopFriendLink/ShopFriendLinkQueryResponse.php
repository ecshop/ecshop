...
#[OA\Schema(schema: 'ShopFriendLinkQueryResponse')]
class ShopFriendLinkQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopFriendLinkResponse::class))]
    private array $data;
