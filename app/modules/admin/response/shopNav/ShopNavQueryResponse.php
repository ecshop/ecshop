...
namespace app\modules\admin\response\shopNav;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ShopNavQueryResponse')]
class ShopNavQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopNavResponse::class))]
    private array $data;
