...
#[OA\Schema(schema: 'ShopPluginsQueryResponse')]
class ShopPluginsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopPluginsResponse::class))]
    private array $data;
