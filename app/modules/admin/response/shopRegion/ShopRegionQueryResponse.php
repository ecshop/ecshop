...
#[OA\Schema(schema: 'ShopRegionQueryResponse')]
class ShopRegionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopRegionResponse::class))]
    private array $data;
