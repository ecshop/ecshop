...
#[OA\Schema(schema: 'ShopStatsQueryResponse')]
class ShopStatsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShopStatsResponse::class))]
    private array $data;
