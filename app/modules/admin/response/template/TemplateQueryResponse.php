...
namespace app\modules\admin\response\template;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'TemplateQueryResponse')]
class TemplateQueryResponse
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: TemplateResponse::class))]
    private array $data;
