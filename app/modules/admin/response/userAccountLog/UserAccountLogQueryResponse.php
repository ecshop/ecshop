...
#[OA\Schema(schema: 'UserAccountLogQueryResponse')]
class UserAccountLogQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserAccountLogResponse::class))]
    private array $data;
