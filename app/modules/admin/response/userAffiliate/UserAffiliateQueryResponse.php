...
#[OA\Schema(schema: 'UserAffiliateQueryResponse')]
class UserAffiliateQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserAffiliateResponse::class))]
    private array $data;
