...
#[OA\Schema(schema: 'UserCartQueryResponse')]
class UserCartQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserCartResponse::class))]
    private array $data;
