...
#[OA\Schema(schema: 'UserCollectQueryResponse')]
class UserCollectQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserCollectResponse::class))]
    private array $data;
