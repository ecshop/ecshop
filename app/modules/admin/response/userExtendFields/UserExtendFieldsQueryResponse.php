...
#[OA\Schema(schema: 'UserExtendFieldsQueryResponse')]
class UserExtendFieldsQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserExtendFieldsResponse::class))]
    private array $data;
