...
#[OA\Schema(schema: 'UserExtendInfoQueryResponse')]
class UserExtendInfoQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserExtendInfoResponse::class))]
    private array $data;
