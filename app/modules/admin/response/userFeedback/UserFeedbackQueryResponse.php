...
#[OA\Schema(schema: 'UserFeedbackQueryResponse')]
class UserFeedbackQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserFeedbackResponse::class))]
    private array $data;
