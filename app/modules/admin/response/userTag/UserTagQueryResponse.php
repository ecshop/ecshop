...
#[OA\Schema(schema: 'UserTagQueryResponse')]
class UserTagQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserTagResponse::class))]
    private array $data;
