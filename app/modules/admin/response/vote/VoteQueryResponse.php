...
#[OA\Schema(schema: 'VoteQueryResponse')]
class VoteQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: VoteResponse::class))]
    private array $data;
