...
DROP PRIMARY KEY,
ADD PRIMARY KEY (`id`),
ADD UNIQUE INDEX (`goods_id`,`article_id`);
...
DROP PRIMARY KEY,
ADD PRIMARY KEY (`id`),
ADD UNIQUE INDEX (`parent_id`,`goods_id`);
...
DROP PRIMARY KEY,
ADD PRIMARY KEY (`id`),
ADD UNIQUE INDEX (`goods_id`,`link_goods_id`);

ALTER TABLE `package_goods`
ADD COLUMN `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT FIRST,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`id`),
ADD UNIQUE INDEX (`package_id`,`goods_id`,`product_id`);
...
ALTER TABLE `topic`
CHANGE COLUMN `topic_id` `topic_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT FIRST;
